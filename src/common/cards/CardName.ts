export enum CardName {
  ...
  DEEP_WELL_HEATING = 'Deep Well, Well, Well Heating',
  ...
  GYROPOLIS = 'Gyropolis',
  HACKERS = 'Hackers',
  HEATHER = 'Heather? Hardly know her!',
  ...
  MARKET_MANIPULATION = 'Market Manip',
  ...
  SUBZERO_SALT_FISH = 'Sub-zero Salty Fish',
  SHUTTLES = 'Shuttles',
  ...
  FORCED_PRECIPITATION = 'Forced Precip',
  ...
  ORBITAL_CLEANUP = 'Orbital Clean-her-up',
  ...
  CUTTING_EDGE_TECHNOLOGY = 'Cutting Edge Tech',
